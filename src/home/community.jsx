  ...
  <main>
    ...
    <section class="bg-green-600 py-10 text-center text-white lg:py-20">
      <div class="container mx-auto">
        <h1 class="mb-2 text-4xl font-bold lg:text-5xl">Community Forums</h1>
    ...
    <section class="container mx-auto px-6 py-8">
      <h2 class="mb-6 text-center text-3xl font-semibold">Discussion Boards</h2>
      <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        <div class="rounded-lg bg-white p-6 shadow-lg">
          <h3 class="mb-4 text-xl font-semibold">Design and Inspiration</h3>
        ...
        <div class="rounded-lg bg-white p-6 shadow-lg">
          <h3 class="mb-4 text-xl font-semibold">Fashion Business</h3>
          <p class="mb-4 text-gray-700">
        ...
        <div class="rounded-lg bg-white p-6 shadow-lg">
          <h3 class="mb-4 text-xl font-semibold">Sustainable Fashion</h3>
          <p class="mb-4 text-gray-700">
    ...
    <section class="bg-green-50 py-8">
      <div class="container mx-auto px-6 text-center">
        <h2 class="mb-6 text-3xl font-semibold">User Engagement</h2>
